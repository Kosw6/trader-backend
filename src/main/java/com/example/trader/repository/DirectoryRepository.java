...
public interface DirectoryRepository extends JpaRepository<Directory,Long> {
    boolean existsByIdAndTeamId(Long dirId, Long teamId);
    List<Directory> findAllByTeamId(Long teamId);
    Optional<Directory> findByIdAndTeamId(Long id, Long teamId);
    ...
    SELECT id FROM sub ORDER BY id
    """, nativeQuery = true)
    List<Long> findDirectorySubtreeIdsInTeam(@Param("dirId") Long dirId,
